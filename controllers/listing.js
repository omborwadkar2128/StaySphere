...
module.exports.showListing = async (req, res) => {
    ...
    res.render("listings/show.ejs", { listing, mapboxToken: mapToken });
};
...
// module.exports.index = async (req, res) => {
//     const allListings = await Listing.find({});
//     res.render("listings/index", { allListings }); // removed .ejs
// };

// module.exports.renderNewForm = (req, res) => {
//     res.render("listings/new"); // removed .ejs
// };
...
//     // Pass the token to the template
//     res.render("listings/show", { listing, mapboxToken: mapToken }); // removed .ejs
// };
